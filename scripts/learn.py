    ...
    for cuf in cum_files:
        ...
        try:
            ...
            if not isinstance(cq, list):
                results.append((cuf.name, range_errs + ['quality: not a top-level list']))
                continue
            ...
            if errs or range_errs:
                results.append((cuf.name, range_errs + errs))
        except Exception as e:
            results.append((cuf.name, range_errs + [f'quality: parse error {e}']))
